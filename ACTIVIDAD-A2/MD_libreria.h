...
int MD_SumaN()
{
	int MD_c=0,MD_a;                                      float MD_s=0,MD_b;                                    cout<<"Ingrese la cantidad de numeros a sumar: ";     
	cin>>MD_a;                                            do{                                                   cout<<"Ingrese un nunero: ";                          cin>>MD_b;                                            MD_c=MD_c+1;                                          MD_s=MD_s+MD_b;                                       }while(MD_c<MD_a);                                                                                  cout<<"//==============================================="<<endl;      
